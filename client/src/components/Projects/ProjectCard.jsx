...
export default function ProjectCard({
  ...
  return (
    <div key={projectId} data-default={isDefaultProject} className="projectWrapper_ProjectCard relative w-[290px] rounded-tr-2xl rounded-br-2xl rounded-bl-2xl overflow-visible transition-all duration-200 ease-in-out cursor-pointer no-underline hover:-translate-y-0.5">
      <div className="starWrapper_ProjectCard relative top-px left-0 bg-background-secondary-color w-40 h-[30px] rounded-tl-2xl rounded-tr-0 rounded-bl-0 rounded-br-0 [clip-path:path('M_0_0_L_128_0_C_144_2_136_24,_160_34_L_0_34_Z')]">
      ...
      <Link href={href}>
        <div className="contentWrapper_ProjectCard bg-background-secondary-color py-[18px] px-[22px] min-h-[181px] rounded-tr-2xl rounded-bl-2xl rounded-br-2xl rounded-tl-none transition-all duration-200 ease-in-out hover:shadow-[10px_10px_10px_rgba(0,0,0,0.1)] hover:!text-transparent">
