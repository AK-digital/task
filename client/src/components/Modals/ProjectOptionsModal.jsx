    ...
    const handleDeleteProject = async () => {
        if (confirm("Voulez-vous vraiment supprimer ce projet ?")) {
            try {
                ...
                console.error(err.message || "Une erreur est survenue lors de la suppression du projet");
            }
        }
    };
    ...
    return (
        <>
            <div className={styles.overlay}>
                <span className={styles.closeButton} onClick={() => setOpenModal(false)}>
                    <X size={32} />
                </span>
                ...
                <div className={styles.content}>
                    <form action={formAction} ref={formRef}>
                        ...
                        <div className={styles.logoContainer}>
                            ...
                            >
                                <Image
                                    src={previewUrl || state.data?.logo || "/default-project-logo.webp"}
                                    alt="Logo du projet"
                                    width={120}
                                    height={120}
                                    quality={100}
