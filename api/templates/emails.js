export function emailDescription(user, task) {
  const templates = {
    ...
    text: `
      ...
      <h2 style="font-size: 28px; max-width: 450px; margin-inline: auto; font-weight: 500;">${user?.firstName + " " + user?.lastName
...
export function emailProjectInvitation(project, sender, link) {
  const templates = {
    ...
    text: `
      ...
      <div style="font-size: 20px; font-weight: 300; max-width: 300px;text-align: center;">
       <p>
