...
export async function updateTask(taskId, projectId, prevState, formData) {
  try {
    ...
    if (formData.get("En attente"))
      data.append("status", formData.get("En attente"));
    if (formData.get("À faire")) data.append("status", formData.get("À faire"));
    if (formData.get("En cours"))
      data.append("status", formData.get("En cours"));
    if (formData.get("Bloquée")) data.append("status", formData.get("Bloquée"));
    if (formData.get("Terminée"))
      data.append("status", formData.get("Terminée"));
