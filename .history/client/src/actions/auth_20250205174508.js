...
export async function resetForgotPassword(prevState, formData) {
  try {
    ...
    if(regex.password.test(newPassword)) {
      return {
        status: "failure",
        errors: { newPassword: "Le mot de passe doit contenir au moins 8 caractères, une majuscule, une minuscule et un chiffre" },
      };
    }
    ...
    return {
      status: "failure",
      message: err.message || "Une erreur est survenue lors de la réinitialisation de votre mot de passe
  }
}
