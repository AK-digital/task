        ...
        <div className={styles.container}>
            ...
            <form className={styles.form} action={formAction}>
                ...
                <div className={styles.buttons}>
                    <button onClick={(e) => e.preventDefault()} data-disabled={pending} className={instrumentSans.className} disabled={pending}>{pending ? "Inscription en cours..." : "S'inscrire"}</button>
