...
export default function TaggedUsersModal({
  ...
  function handleTaggedUsers(guest) {
    ...
    if (lastAtPosition !== null) {
      ...
      editor.insertEmbed(lastAtPosition, "spanEmbed", mentionText);
      editor.insertText(lastAtPosition + mentionText.length, " ");

      // Mettre à jour la position du curseur après l'insertion
      editor.setSelection(lastAtPosition + mentionText.length + 1, 0);
    }
