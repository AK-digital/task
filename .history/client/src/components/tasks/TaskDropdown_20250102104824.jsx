...
export default function TaskDropdown({
  ...
  async function handleUpdateTask(e) {
    ...
    if (type === "status") {
      ...
      if (value === "En attente") status = "pending";
      if (value === "À faire") status = "todo";
      if (value === "En cours") status = "processing";
      if (value === "Bloqué") status = "blocked";
      if (value === "Terminée") status = "finished";
