...
export default function TaskResponsibles({ task, project }) {
  ...
  async function handleRemoveResponsible(e, responsible) {
    const findDeletedResponsible = optimisticResponsibles.find(
      (deletedResponsible) => {
        console.log(deletedResponsible);
        console.log(responsible);
        deletedResponsible?._id === responsible?._id;
      }
    );

    console.log(findDeletedResponsible);
    // setOptimisticResponsibles((prev) => [...prev, responsible]);
