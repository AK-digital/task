          ...
          <div className={styles.modal}>
                ...
                <ul className={styles["responsibles__list"]}>
                  {responsibles.map((responsible) => (
                    <li
                      key={responsible.id}
                      onClick={(e) =>
                        handleRemoveResponsible(e, responsible.id)
                      }
                    >
                      <Image
                        src={responsible.picture || "/default-pfp.webp"}
            ...
            <div className={styles["guests__container"]}>
              ...
              <ul className={styles["guests__list"]}>
                {!isAuthorResponsible && author && (
                  <li onClick={(e) => handleAddResponsible(e, author.id)}>
                    <Image
                ...
                {filteredGuests.map((guest) => (
                  <li
                    key={guest.id}
                    onClick={(e) => handleAddResponsible(e, guest.id)}
                  >
                    <Image
