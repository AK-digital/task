...
// Import Quill lui-même (il sera chargé dynamiquement)
const ReactQuill = dynamic(() => import("react-quill-new"), {
  ssr: false,
  loading: () => <p>Chargement de l'éditeur...</p>,
});

// Configuration du format de mention personnalisé
const Embed = ReactQuill.import("blots/embed");
...
class MentionBlot extends Embed {
  ...
  static value(node) {
    return {
      ...
      fullName: node.textContent.slice(1), // Enlever le @ du début
    };
  }
}
