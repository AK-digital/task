...
export default function RichTextEditor({
  ...
  const [filteredGuests, setFilteredGuests] = useState([]); // Nouveau state pour les résultats filtrés
  ...
  useEffect(() => {
    ...
    const filtered = projectGuests.filter((projectGuest) =>
      projectGuest?.firstName
        ?.toLowerCase()
        .includes(lastWordWithoutAt.toLowerCase())
    );

    setFilteredGuests(filtered);
  }, [lastWord, projectGuests]);
