...
export default function RichTextEditor({
  ...
  function getMentionPosition() {
    ...
    if (selection) {
      ...
      const quillContainer = editor.container.getBoundingClientRect();

      setMentionPosition({
        top: bounds.bottom + quillContainer.top + window.scrollY,
        left: bounds.left + quillContainer.left,
      });
    }
  }
        ...
        <div className="relative">
          ...
          {isTaggedUsers && (
            ...
            >
              ...
              Liste des utilisateurs à mentionner
            </div>
          )}
        </div>
      )}
