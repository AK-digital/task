...
export default function RichTextEditor({
  ...
  function handleKeydown(e) {
    ...
    // Capturer la position du curseur
        ...
        <div>
          ...
          {isTaggedUsers && (
            <div
              style={{
                position: "absolute",
                top: cursorPosition.y + 10 + "px", // Décalage pour placer sous le curseur
                left: cursorPosition.x + "px", // Alignement horizontal avec l'arobase
              }}
            >
              {/* Affichage des utilisateurs tagués */}
              <div>Utilisateurs tagués...</div>
            </div>
          )}
        </div>
      )}
