  ...
  return (
    <>
      <ReactQuill
        ...
        defaultValue={
          isDescription && task?.description ? task.description : "" // DefaultValue pour les descriptions
        }
        value={isConversation ? content : undefined} // Value défini uniquement pour les conversations
        onChange={(value) => {
          if (isConversation) {
            setContent(value); // Mise à jour du contenu uniquement pour les conversations
          }
        }}
      />
