...
export default function RichTextEditor({
  ...
  const [projectGuests, setProjectGuests] = useState(project?.guests || []);
  ...
  useEffect(() => {
    ...
    for (const projectGuest of projectGuests) {
      if (projectGuest?.firstName?.includes(lastWordWithoutAt)) {
        setProjectGuests((prevState) => [...prevState, projectGuest]);
      }
    }

    console.log(projectGuests);
  }, [lastWord]);
