...
<div style="font-family: Arial, sans-serif; color: #333; text-align: center; padding: 20px;">
  ...
  <div style="margin: 20px 0;">
    <button style="background-color: #4CAF50; color: white; border: none; padding: 10px 20px; font-size: 16px; margin: 5px; cursor: pointer;">
  ...
  <p style="font-size: 12px; color: #777;">Si vous n’êtes pas à l’origine de cette invitation, veuillez ignorer cet e-mail.</p>
</div>
`;
