...
export async function sendGuestInvitation(req, res, next) {
  ...
  <div style="font-family: Arial, sans-serif; color: #333; text-align: center; padding: 20px;">
    ...
    <div style="margin: 20px 0;">
      <button style="background-color: #5056C8; color: white; border: none; padding: 10px 20px; font-size: 16px; margin: 5px; cursor: pointer; font-weight: bold; border-radius: 8px;">
        Accepter l'invitation
      </button>
      <button style="background-color: #f44336; color: white; border: none; padding: 10px 20px; font-size: 16px; margin: 5px; cursor: pointer; font-weight: bold; border-radius: 8px;">
