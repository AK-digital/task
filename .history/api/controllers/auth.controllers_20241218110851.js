...
export async function signIn(req, res, next) {
  try {
    ...
    const accessToken = generateAccessToken(user); // Generating access token and passing user info as parameter
    const refreshToken = generateRefreshToken(user); // Generating refresh token and passing user info as parameter
