...
export async function sendGuestInvitation(req, res, next) {
  ...
  <div style="font-family: Arial, sans-serif; color: #333; text-align: center; padding: 20px;">
    ...
    <p>Bonjour,</p>
    <p>Vous avez été invité à participer à un nouveau projet par <strong>${authEmail}</strong>. Cette opportunité vous permettra de collaborer avec votre équipe et de contribuer à l’avancement du projet.</p>
